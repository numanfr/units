...
/// ```
    pub fn get_value(&self) -> Value{
        match *self {
            DerivedUnit::Hertz => Value{magnitude: 1_f64,si_units_num: Vec::from([]),si_units_den: Vec::from([SiUnit::Second])},
            ...
            DerivedUnit::Coulombs => DerivedQuantities::Time.get_value().add_num(SiUnit::Second),
